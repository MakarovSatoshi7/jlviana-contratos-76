...
export function ContratoForm({
  ...
  const handleCustomTipoServicoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    updateFormData({ tipoServicoId: value });
  };

  const handleNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    const parsedValue = parseInt(value, 10);
    updateFormData({ [name]: isNaN(parsedValue) ? 0 : parsedValue });
  };
  ...
  const handleClienteChange = (field: keyof Cliente, value: string) => {
    setClienteEditData(prev => ({ ...prev, [field]: value }));
    setHasClienteChanges(true);
  };

  const handleSaveClienteChanges = () => {
    if (!formData.clienteId || !hasClienteChanges) return;
    updateClienteMutation.mutate({ id: formData.clienteId, ...clienteEditData });
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {selectedCliente && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <Input
                  id="representante-nacionalidade-edit"
                  value={clienteEditData.representanteNacionalidade || ''}
                  onChange={e => handleClienteChange('representanteNacionalidade', e.target.value)}
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="representante-estado-civil-edit"
                  value={clienteEditData.representanteEstadoCivil || ''}
                  onChange={e => handleClienteChange('representanteEstadoCivil', e.target.value)}
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="representante-profissao-edit"
                  value={clienteEditData.representanteProfissao || ''}
                  onChange={e => handleClienteChange('representanteProfissao', e.target.value)}
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="representante-rg-edit"
                  value={clienteEditData.representanteRg || ''}
                  onChange={e => handleClienteChange('representanteRg', e.target.value)}
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="representante-orgao-emissor-edit"
                  value={clienteEditData.representanteOrgaoEmissor || ''}
                  onChange={e => handleClienteChange('representanteOrgaoEmissor', e.target.value)}
                  className="mt-1"
                />
              </div>
            </div>
          ...
          {formData.clienteId && !selectedCliente?.representanteNome && (
          ...
          <div>
            ...
            {!isCustomType ? (
              <Select value={formData.tipoServicoId} onValueChange={value => handleSelectChange('tipoServicoId', value)}>
                ...
                <SelectContent>
                  {TIPOS_SERVICOS_PADROES.map(tipo => (
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                type="text"
                id="numeroNotasServicos"
                name="numeroNotasServicos"
            ...
            <div>
              ...
              <Input
                type="text"
                id="numeroNotasEntradaSaida"
                name="numeroNotasEntradaSaida"
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Input
              type="number"
              id="preAvisoRescisao"
              name="preAvisoRescisao"
              value={formData.preAvisoRescisao}
              onChange={handleNumberChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="number"
              id="multaRescisioriaPercentual"
              name="multaRescisioriaPercentual"
              value={formData.multaRescisioriaPercentual}
              onChange={handleNumberChange}
            />
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Dados da Contratada</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              type="text"
              id="contratadaRepresentanteNome"
              name="contratadaRepresentanteNome"
              value={formData.contratadaRepresentanteNome}
              onChange={handleChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="text"
              id="contratadaRepresentanteNacionalidade"
              name="contratadaRepresentanteNacionalidade"
              value={formData.contratadaRepresentanteNacionalidade}
              onChange={handleChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="text"
              id="contratadaRepresentanteEstadoCivil"
              name="contratadaRepresentanteEstadoCivil"
              value={formData.contratadaRepresentanteEstadoCivil}
              onChange={handleChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="text"
              id="contratadaRepresentanteProfissao"
              name="contratadaRepresentanteProfissao"
              value={formData.contratadaRepresentanteProfissao}
              onChange={handleChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="text"
              id="contratadaRepresentanteCrc"
              name="contratadaRepresentanteCrc"
              value={formData.contratadaRepresentanteCrc}
              onChange={handleChange}
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              name="contratadaRepresentanteCpf"
              value={formData.contratadaRepresentanteCpf}
              onChange={handleChange}
            />
          </div>
        </CardContent>
      ...
      {showSaveButton && (
        <Button type="submit" className="w-full">Salvar Contrato</Button>
      )}
    </form>
  );
}
