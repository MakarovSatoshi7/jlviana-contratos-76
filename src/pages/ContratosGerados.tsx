      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {contratos.length === 0 ? <p className="text-muted-foreground text-center py-8">
                Nenhum contrato gerado ainda.
              </p> : contratos.map(contrato => {
            ...
            return <div key={contrato.id} className="border rounded-lg overflow-hidden">
                    {/* Contract Header */}
                    <div className="flex items-center justify-between p-4 bg-muted/30 border-b">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2 text-sm text-muted-foreground">
                          ...
                          <p>
                            <span className="font-medium">Valor:</span> R$ {contrato.valorMensalidade.toLocaleString('pt-BR', {
                      ...
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" onClick={() => toggleContractView(contrato.id)}>
                          {isExpanded ? <>
                        ...
                        {cliente && <ContratoPDF contrato={contrato} cliente={cliente} tipoServico={tipoServico} />}
                        <Button variant="destructive" size="sm" onClick={() => handleDeleteContrato(contrato.id)}>
                    ...
                    {/* Contract Content */}
                    {isExpanded && cliente && <div className="p-6 bg-white">
